<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <a href="<?php echo erLhcoreClassDesign::baseurl('fbwhatsappmessaging/import')?>?sample=1"><span class="material-icons">file_download</span><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('module/fbmessenger','Download sample');?></a>
    </div>
