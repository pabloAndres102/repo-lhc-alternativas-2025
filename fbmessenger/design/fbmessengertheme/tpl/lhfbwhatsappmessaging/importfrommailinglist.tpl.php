        ...
        <div class="modal-footer">
            <div class="btn-group">
                <?php if (!(isset($updated) && $updated == true)) : ?>
                    ...
                    <button type="submit" name="UnassignedAction" onclick="$('#id_export_action').val('unassign')" class="btn btn-warning btn-sm"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('module/fbmessenger','Remove selection from contact list')?></button>
                <?php endif; ?>
