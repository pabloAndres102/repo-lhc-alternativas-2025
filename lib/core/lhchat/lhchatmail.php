...
class erLhcoreClassChatMail {
	...
	public static function sendInfoMail($userData, $recipient, $additionalContent = '') {
		$mail = new PHPMailer(true);
		$mail->CharSet = "UTF-8";
		$mail->IsHTML(true);
		...
		// Agrega el contenido adicional al cuerpo del correo
		$mail->Body = 'Informacion de estadisticas: <br>' . $additionalContent;
